      ...
      <div className={[['jumbotron'], ['jumbotron-fluid'], Style['jumbotron-visit-store']].join(' ')}>
        <div className="container">
          <h4
            ...
            data-aos-delay="3"
            data-aos-once="true"
            className={Style['visit-store-title']}>Visit Our Store in the Spot on the Map Below</h4>
          <p
            data-aos="fade-up"
            data-aos-duration="1000"
            data-aos-easing="ease-in-out"
            data-aos-delay="3"
            data-aos-once="true"
            className={Style['visit-store-teks']}>See our store in every city on the spot and spen your good day there. See you soon!</p>
          <div
            data-aos="zoom-in"
            ...
            data-aos-delay="6"
            data-aos-once="true"
            className={Style['visit-store-img']}></div>
