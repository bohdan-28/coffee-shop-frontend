...
function HomeGetStarted() {
  return (
    <div>
      <div class={[['jumbotron'], ['jumbotron-fluid'], Style['jumbotron-get-started']].join(' ')}>
        <div class="container">
          ...
          <button type="button" class={[['btn'], ['btn-warning'], Style['btn-get-started']].join(' ')}>Get Started</button>
