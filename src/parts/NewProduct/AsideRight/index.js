                ...
                <div className="container">
                    <div className="row">
                        <div className={style.formData}>
                            ...
                            <p className={style.textSize}>Click size you want to use for this product</p>
                            ...
                            <p className={style.textSize}>Click methods you want to use for this product</p>
                            ...
                            <Button title="Save Product" btn="btn-save" onClick="" />
