      ...
      <div className="row">
        <div className="col">
          ...
          <div className={style['order-card']}>
            <h5 className={style['title-sum']} >Order Summary</h5>
            <div className={[['row'],['mb-lg-5'],style['map-card']].join(' ')}>
              <div className={[["col"], style["column"]].join(" ")}>
                <img src={picture} alt="" />
              </div>
              <div className={[["col"], style["column-title"]].join(" ")}>
            ...
            <div className={style['btn-com-pay']}>
        ...
        <div className={[["col"], ["ml-lg-5"], ["mt-lg-5"], style["body-resp"]].join(" ")}>
          {/* Awal card address */}
          <div className="row">
            <div className="col">
